...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "YL6834imBGapqOX75Cppc7KG";
    public static String secretKey = "poSGWNV3P32AMs2oiELTfgMexs6wm8uG";
    public static String licenseID = "androidFaceOne-face-android";
     ...
     */
    public static String groupID = "AndroidTest2018";
